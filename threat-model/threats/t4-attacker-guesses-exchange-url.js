(function () {
    var threat = {
        ...
        response: [
            { id: "R6", name: "Obfuscated Exchange ID Generation", type: "Reduce", desc: "When generating an exchange ID, utilize random identifiers that cannot be easily guessed or brute forced." },
