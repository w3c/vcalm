(function () {
    var threat = {
        ...
        response: [
            { id: "R3", name: "Zero Trust and mTLS Execution", type: "Reduce", desc: "Implement strict network segmentation and other mechanisms such as mandated mutual Transport Layer Security (mTLS) with cryptographically validated identity tokens for all internal service-to-service APIs." },
