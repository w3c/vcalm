(function () {
    var threat = {
        ...
        desc: "An issuer administrator misconfigures some aspect of the issuance software, whether that be the coordinator service or the workflow service related to issuing credentials, leading to false issuance or an incorrect rejection of an issuance request.",
        response: [
