(function () {
    var threat = {
        ...
        desc: "Attackers perform a denial of service attack against one or more public coordinator endpoints, causing severe degradation of availability for legitimate clients.",
        response: [
