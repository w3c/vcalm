(function () {
    var threat = {
        ...
        response: [
            { id: "R9", name: "Cryptographic Sender Binding", type: "Reduce", desc: "Enforce cryptographic Authorization Capabilities, Demonstrated Proof-of-Possession (DPoP), or mutual Transport Layer Security (mTLS) client binding to ensure security tokens are useless if extracted from the originating environment." },
